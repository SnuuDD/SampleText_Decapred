<?php
    ...
    $idP = htmlspecialchars($_SESSION["idP"]); 
    ...
    if((isset($_POST["Coordinacioness"])) and (isset($_POST["nombre"])) AND (isset($_POST["fechaI"])) AND (isset($_POST["fechaF"])) AND (isset($_POST["objetivo"]))) {
        if (editaPrograma($idP,$Coordinaciones, $nombre, $fechaI, $fechaF, $objetivo)) {
            $_SESSION["mensaje"] = "Se ha editado el programa con éxito";
            //echo "success";
        } else {
